...
var BRole = /** @class */function () {
    ...
    BRole.isUser = function (roleCode) {
        return roleCode === BRole.user_role.user.code;
    };
    BRole.isAdmin = function (roleCode) {
        return roleCode === BRole.user_role.admin.code;
    };
    BRole.isAdminSuper = function (roleCode) {
        return roleCode === BRole.user_role.superAdmin.code;
    };
