class BMHelperLanguage {
  ...
  static getLanguageObj(code: string): any {
    ...
    code = code.trim();
    return BMHelperLanguage.languageObj[code];
  }
  ...
  static getLanguageNative(code: string): string {
    ...
    code = code.trim();
    return BMHelperLanguage.languageObj[code] ? BMHelperLanguage.languageObj[code][1] : code;
  }
  ...
  static getLanguageName(code: string): string {
    ...
    code = code.trim();
    return BMHelperLanguage.languageObj[code] ? BMHelperLanguage.languageObj[code][0] : code;
  }

  static setupArr(langCodeArr: string[]) {
    const langArr: any[] = [];
    for (const key of langCodeArr) {
      langArr.push([key, BMHelperLanguage.languageObj[key][0], BMHelperLanguage.languageObj[key][1]]);
    }
    return langArr;
  }

  constructor() {
    for (const key in BMHelperLanguage.languageObj) {
      this.languageArr.push([key, BMHelperLanguage.languageObj[key][0], BMHelperLanguage.languageObj[key][1]]);
    }
  }
}

export default BMHelperLanguage;
